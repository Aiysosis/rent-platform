<template>
  <div>
    <img src="../assets/img/bg-banner-custome.jpg" style="z-index: -100; position: fixed; top: 8%; bottom: 0; height: 92%" />
    ...
    <div style="position: absolute; top: 28%; left: 46%; z-index: 99">
      ...
      <el-upload
        ...
        list-type="picture"
      >
        <el-button style="min-height: 100px; min-width: 100px" icon="el-icon-plus" />
      </el-upload>
    </div>
    <el-card style="width: 55%; height: 70%; position: absolute; top: 20%; left: 10%; border-radius: 35px; padding: 50px">
      <el-form :model="itemForm" :rules="rules" ref="itemForm" label-width="150px" style="width: 60%">
        ...
        <el-form-item label="Price per Day" prop="rent_daily">
          <el-input-number v-model="itemForm.rent_daily" controls-position="right" :min="0" :step="1" style="width: 100%"> </el-input-number>
        </el-form-item>

        <el-form-item label="Depoist" prop="deposit">
          <el-input-number v-model="itemForm.deposit" controls-position="right" :min="0" :step="1" style="width: 100%"> </el-input-number>
        </el-form-item>
        ...
        <el-form-item>
          <el-button type="primary" round @click="submitForm('itemForm')">Upload</el-button>
