  ...
  <div class="user-info">
    <el-tabs type="border-card" tab-position="left" style="border-radius: 25px">
      <el-tab-pane label="Personal Data">
        <el-form ref="PersonalData" :model="PersonalData" label-width="20%" style="margin-top: 4%">
          <el-form-item label="Avatar：">
            <el-upload
              ...
              list-type="picture"
            >
              <el-avatar :size="100" icon="el-icon-user-solid" :src="this.PersonalData.avatar"></el-avatar>
            </el-upload>
          </el-form-item>
          <el-form-item label="Nickname：">
            <el-input v-model="PersonalData.nick_name" :disabled="editflag" class="input"> </el-input>
          </el-form-item>
          <el-form-item label="Gender：">
            <el-input v-model="PersonalData.gender" :disabled="editflag" class="input"> </el-input>
          </el-form-item>
          <el-form-item label="Telephone：">
            <el-input v-model="PersonalData.telephone" :disabled="editflag" class="input"> </el-input>
          </el-form-item>
          <el-form-item label="E-mail：">
            <el-input v-model="PersonalData.email" :disabled="editflag" class="input"> </el-input>
          </el-form-item>
          <el-form-item label="Zone：">
            <el-input v-model="PersonalData.zone" :disabled="editflag" class="input"> </el-input>
          </el-form-item>
          <el-form-item>
            <el-button icon="el-icon-edit" round v-show="editflag" @click="editflag = false">Edit </el-button>
            <el-button icon="el-icon-check" type="success" round v-show="!editflag" @click="editUser"> Preserve </el-button>
            <el-button round v-show="!editflag" @click="editflag = true">Cancel </el-button>
          </el-form-item>
        </el-form>
      </el-tab-pane>
      <el-tab-pane label="Account Information">
        <el-form label-width="20%">
          <el-form-item label="User ID：">{{ PersonalData.userId }} </el-form-item>
          <el-form-item label="Password：">
            <el-input v-model="PersonalData.password" :disabled="true" type="password" class="input"> </el-input>
            <el-button type="primary" icon="el-icon-edit" round @click="passwordchange = true" style="position: relative; left: 15px"> Change Password </el-button>
          </el-form-item>
          <el-form-item label="Register Time：">{{ PersonalData.register_time }} </el-form-item>
          <el-form-item label="Role：">
            <span v-if="PersonalData.role == 0">Ordinary User </span>
            <span v-else>Administrator</span>
          </el-form-item>
          <el-form-item label="Reputation：">{{ PersonalData.reputation }} </el-form-item>
        </el-form>
        <el-dialog title="Change Password" :visible.sync="passwordchange" width="40%" center>
          <el-form :model="passForm" status-icon :rules="rules" ref="passForm" label-width="25%" style="margin-right: 5%">
          ...
          <span slot="footer">
            <el-button type="primary" @click="submitForm('passForm')" round>Confirm</el-button>
...
export default {
  mounted() {
    ...
    if (!user) {
      ...
      this.PersonalData.register_time = user.joinTime;
    }
